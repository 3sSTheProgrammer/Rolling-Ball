	...
	UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult)
{
	...
	if (ARollingBallPawn* PlayerActor = Cast<ARollingBallPawn>(OtherActor))
	{
		//Check if win condition is met
		TArray<AActor*> RemainedEnemies;
		UGameplayStatics::GetAllActorsOfClass(GetWorld(), ARollingBallEnemyActor::StaticClass(), RemainedEnemies);
