...
class ARollingBallEnemyActor;

UCLASS()
class ROLLINGBALL_API ARollingBallPawn : public APawn
{
	GENERATED_BODY()
...
protected:
	...
	TArray<ARollingBallEnemyActor*> EnemiesImpactedByAbility;
...
protected:
	...
	TArray<ARollingBallEnemyActor*> GetEnemiesInRange(float Range);
